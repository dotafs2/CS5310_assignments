...
//
/*
 * The test file for perlin noise mainly contains all the equations in my report, including one level perlin, multi level perlin and other related equations using perlin, test equations.
 */
#include <iostream>
#include <cstdlib>
#include <sys/stat.h>
